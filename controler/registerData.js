...
const reg = (req,res)=>{
    ...
    try {
        const {Name, DOB, BloodGroup, Address, State, Pincode, MobileNo, Username, Password} = req.body;
        const query = 'INSERT INTO reg (Name, Dob, BloodGroup, Address, State, Pincode, MobileNo, Username, Password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)';
        con.query(query, [Name, Dob, BloodGroup, Address, State, Pincode, MobileNo, Username, Password],(err,resuld)=>{
            if (err) {
